...
This sample demonstrates how to use `arcgis-coding-components` in a widget. This widget works between the version 1.17 and 1.18. Before the versions of 1.17, widgets need to handle the initialization of the coding components.
