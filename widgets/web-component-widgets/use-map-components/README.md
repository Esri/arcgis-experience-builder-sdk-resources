# Use Map Components
This sample demonstrates how to use `arcgis-map-components` in a widget. This widget works between the version 1.15 and 1.18. For 1.19, please see the `use-web-components-19` sample widget.
